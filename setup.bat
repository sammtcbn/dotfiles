...
@set currdir=%~dp0
@xcopy /Y %currdir%\bin_for_win\*.* C:\Users\%UserName%\AppData\Local\Microsoft\WindowsApps
@xcopy /Y %currdir%\git_script_for_win\*.* C:\Users\%UserName%\AppData\Local\Microsoft\WindowsApps
